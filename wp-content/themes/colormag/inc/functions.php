...
function colormag_footer_copyright() {
   ...
   $wp_link = '<a href="http://tuvantinhoc.vn" target="_blank" title="Tư vấn tin học"><span>Tư vấn tin học</span></a>';
   ...
   $default_footer_value = sprintf( __( 'Copyright &copy; %1$s %2$s. All rights reserved.', 'colormag' ), date( 'Y' ), $site_link ).'<br>'.sprintf( __( 'Thiết kế bởi: %s.'), $wp_link );
...
?>
   <div class="breaking-news">
      <strong class="breaking-news-latest"><?php _e( 'Mới nhất:', 'colormag' ); ?></strong>
      <ul class="newsticker">
